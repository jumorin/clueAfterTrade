...
public class CRBoardAdjTargetTests {
	...
	public void testTargetsOneStep() {
		...
		Assert.assertTrue(targets.contains(board.calcIndex(20, 7)));
		Assert.assertTrue(targets.contains(board.calcIndex(21, 6)));	
		
		board.startTargets(board.calcIndex(14, 0), 1);
		targets= board.getTargets();
		Assert.assertEquals(3, targets.size());
		Assert.assertTrue(targets.contains(board.calcIndex(14, 1)));
		Assert.assertTrue(targets.contains(board.calcIndex(13, 0)));	
		Assert.assertTrue(targets.contains(board.calcIndex(15, 0)));			
	}
	...
	public void testTargetsTwoSteps() {
		...
		targets= board.getTargets();
		Assert.assertEquals(3, targets.size());
		Assert.assertTrue(targets.contains(board.calcIndex(12, 0)));
		Assert.assertTrue(targets.contains(board.calcIndex(14, 2)));	
	...
	public void testTargetsFourSteps() {
		...
		Assert.assertTrue(targets.contains(board.calcIndex(19, 7)));
		Assert.assertTrue(targets.contains(board.calcIndex(18, 6)));
		Assert.assertTrue(targets.contains(board.calcIndex(20, 6)));
		...
		Assert.assertTrue(targets.contains(board.calcIndex(15, 3)));	
		Assert.assertTrue(targets.contains(board.calcIndex(14, 2)));	
		Assert.assertTrue(targets.contains(board.calcIndex(15, 1)));	
	}	
	...
	public void testTargetsSixSteps() {
		...
		System.out.println(board.calcIndex(15,3));
		System.out.println(board.calcIndex(14,4));
		System.out.println(board.calcIndex(15,1));
		System.out.println(board.calcIndex(14,2));
		System.out.println(board.calcIndex(13,4));
		Assert.assertEquals(7, targets.size());
		Assert.assertTrue(targets.contains(board.calcIndex(14, 6)));
	...
	public void testTargetsIntoRoom()
	{
		...
		Assert.assertTrue(targets.contains(board.calcIndex(15, 16)));
		Assert.assertTrue(targets.contains(board.calcIndex(19, 16)));
		// one up/down, one left/right
		Assert.assertTrue(targets.contains(board.calcIndex(18, 17)));
		Assert.assertTrue(targets.contains(board.calcIndex(18, 15)));
		Assert.assertTrue(targets.contains(board.calcIndex(16, 17)));
		Assert.assertTrue(targets.contains(board.calcIndex(16, 15)));
	}
	...
	public void testTargetsIntoRoomShortcut() 
	{
		...
		Assert.assertTrue(targets.contains(board.calcIndex(9, 7)));
		// directly right (can't go left)
		Assert.assertTrue(targets.contains(board.calcIndex(12, 10)));
		// right then down
		Assert.assertTrue(targets.contains(board.calcIndex(13, 9)));
		...
		// right then up
		Assert.assertTrue(targets.contains(board.calcIndex(10, 8)));
		// into the rooms
		Assert.assertTrue(targets.contains(board.calcIndex(11, 6)));
		Assert.assertTrue(targets.contains(board.calcIndex(10, 6)));		
		// 
		Assert.assertTrue(targets.contains(board.calcIndex(11, 7)));		
		Assert.assertTrue(targets.contains(board.calcIndex(12, 8)));		
	...
	public void testRoomExit()
	{
		...
		targets= board.getTargets();
		Assert.assertEquals(3, targets.size());
		Assert.assertTrue(targets.contains(board.calcIndex(3, 19)));
		Assert.assertTrue(targets.contains(board.calcIndex(5, 19)));
		Assert.assertTrue(targets.contains(board.calcIndex(4, 18)));
	}
